 ...
 *
 * @version 2021-07-08: Migrated to Dagger
 * 2021-04-19: Fixed command output in success & failure to always show
...
public class CliTester {
    ...
    public CliTester execute(final String command, final String... arguments) {
        TestMainComponent component = DaggerTestMainComponent.create();
